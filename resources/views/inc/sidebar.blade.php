        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <ul class="sub-menu collapse" id="staffs">
                    ...
                    <li><a href="/admin/staffs/view">View and Edit Staffs</a></li>
                </ul>
                ...
                <ul class="sub-menu collapse" id="activities">
                    <li><a href="/admin/activities/create">Add Activity</a></li>
                    <li><a href="/admin/activities/view">View and Edit Activities</a></li>
                </ul>
