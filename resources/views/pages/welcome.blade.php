        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <div class="about-content">
                    <p>Children are the pillar to a better future. Your one donation, one effort can make a difference
                        to one life.</p>
                </div>
            </div>
            <!-- /about content -->
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="section-title text-center">
                    ...
                    <p class="sub-title">In a developing country like Nepal, where poverty has its roots in everyone's
                        economy; children end up becoming the victim of it. Each donation counts</p>
                </div>
            </div>
            <!-- section title -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-offset-2 col-md-8">
                            <div class="cta-content text-center">
                                ...
                                <p class="lead">By becoming a volunteer, you get to participate in various activites
                                    and help the kids, also, help to put a smile in their faces. Become a volunteer and
                                    join us now.</p>
